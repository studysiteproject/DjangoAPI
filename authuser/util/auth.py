...
class jwt_auth():
    ...
    def verify_user(self, access_token, user_index):
        ...
        if self.verify_token(access_token):
            ...
            # 쿠키 값 설정
            res.set_cookie('access_token', access_token, httponly=True, secure=True, samesite='none', domain='')
            res.set_cookie('index', user_index, httponly=True, secure=True, samesite='none', domain='')
            return res
        ...
        # access_token이 유효하지 않을 때
            ...
            if refresh_token:
                ...
                if self.verify_refresh_token(refresh_token):
                    ...
                    # 쿠키 값 설정
                    res.set_cookie('access_token', new_access_token, httponly=True, secure=True, samesite='none', domain='')
                    res.set_cookie('index', user_index, httponly=True, secure=True, samesite='none', domain='')

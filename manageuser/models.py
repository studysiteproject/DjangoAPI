...
class UserReport(models.Model):
    ...
    reported_id = models.ForeignKey(
        User,
        on_delete=models.CASCADE,
        related_name="reported",
        db_column="reported_id",
        unique=True,
    )
...
class Applicationlist(models.Model):
    ...
    study_id = models.ForeignKey(
        "managestudy.Study", on_delete=models.CASCADE, db_column="study_id", unique=True
    )
...
class Usertechlist(models.Model):
    user_id = models.ForeignKey(
        ...
        on_delete=models.CASCADE,
        db_column="user_id",
        related_name="techuser",
        primary_key=True,
    )
    tech_id = models.ForeignKey(
        Technologylist, on_delete=models.CASCADE, db_column="tech_id", unique=True
    )
